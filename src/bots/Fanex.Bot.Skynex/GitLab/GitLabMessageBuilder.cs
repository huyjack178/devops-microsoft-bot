    ...
    public class GitLabMessageBuilder : IGitLabMessageBuilder
    {
        ...
        public string BuildJobMessage(JobEvent jobEvent)
        {
            ...
            messageBuilder.Append(
                $":rocket: Gitlab CI: Job「{jobEvent.BuildName.ToUpperInvariant()}」 " +
                $"{MessageFormatSymbol.BOLD_START}{jobEvent.BuildStatus.ToUpperInvariant()}{MessageFormatSymbol.BOLD_END} {statusIcon}{MessageFormatSymbol.NEWLINE}");
